<script lang="ts">
	...
	let {
		...
		message,
		validate
	} = superForm(defaults(zod(LeadSchema)), {
		dataType: 'json',
		invalidateAll: true,
...
{#if $open}
	<div use:melt={$portalled}>
		...
		></div>
		<div class="fixed left-1/2 top-1/2 z-50 max-w-[90vw] min-w-[600px] max-h-[90vh] overflow-y-auto -translate-x-1/2 -translate-y-1/2 rounded-xl bg-surface-900 shadow-lg"
				 use:melt={$content}>
			<Panel extHeaderClass={titleClasses}>
				...
				<form action="?/createLead" method="POST" use:enhance>
					<div class="p-6 space-y-6">
						...
						<!-- Contact Information -->
						<div class="space-y-4">
							<div class="border-b border-surface-300 pb-2 mb-4">
								<h3 class="text-lg font-semibold text-surface-50">Contact Information</h3>
							</div>
						...
						<div class="space-y-4">
							<div class="border-b border-surface-300 pb-2 mb-4">
								<h3 class="text-lg font-semibold text-surface-50">Lead Details</h3>
							</div>
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
								<SelectList
									...
									onchanged={(val) => $form.priority = val as typeof LeadPriority[keyof typeof LeadPriority]}
									wrapperClass="w-full"
								/>
							</div>
						</div>
						...
						<div class="space-y-4">
							<div class="border-b border-surface-300 pb-2 mb-4">
								<h3 class="text-lg font-semibold text-surface-50">Service Address</h3>
							</div>
						...
						<div class="space-y-4">
							<div class="border-b border-surface-300 pb-2 mb-4">
								<h3 class="text-lg font-semibold text-surface-50">Additional Information</h3>
							</div>
							
							<div class="w-full">
								<label for="notes" class="block mb-2 text-sm font-medium label">
						...
						<div class="text-sm text-surface-600">
							<div>* Either company name or at least one of first name or last name is required</div>
